    ...
    <!– для Telegram & WhatsApp –>
        ...
        <section class="video-wpapper">
            <div class="video container">
                <h2 class="video-title">Потрясающая детализация</h2>
                <div class="video-block">

                    <div class="video-link">
                        <a href="#" class="js-first-video" data-links="https://www.youtube.com/embed/CsK1PpTXChU">Посмотреть
                            видео</a>
                ...
                <h2 class="set-title">В комплект входит:</h2>
                <ul class="set-list">
                    <li>
                        <div class="set-list__icon">
                            <img src="/img/set/1.png" alt="">
                        </div>
                        <h3 class="set-list__text">Подробная <span>инструкция на украинском или русском языке (в
                                зависимости
                                от модели)</span> с описанием
                            и последовательностью сборки</h3>
                    </li>
                    <li>
                        <div class="set-list__icon">
                            <img src="/img/set/2.png" alt="">
                        </div>
                        <h3 class="set-list__text">Основание, стены, текстильные, деревянные и пластиковые
                            <span>предметы
                                интерьера</span></h3>
                    </li>
                    <li>
                        ...
                        <h3 class="set-list__text"><span>Оборудование для освещения:</span> LED-светодиоды, включатель,
                            проводные материалы, батарейки</h3>
                    </li>
                    <li>
                        <div class="set-list__icon">
                            <img src="/img/set/4.png" alt="">
                        </div>
                        <h3 class="set-list__text"><span>Всё необходимое для сборки:</span> ножницы, линейка, пинцет,
                            канцелярский нож, трафареты, клеи</h3>
                    </li>
                </ul>
            </div>
        </section>
        ...
        <section class="slider-wrapper container" id="slider-wrapper">
            <h2 class="slider-wrapper__title">Выберите Румбокс мечты для вашего ребенка, друзей или на подарок</h2>
            ...
            <div class="product">
                ...
                <div class="product-content">
                    ...
                    <div class="product-price">
                        ...
                        <a href="#" onclick="return false" data-id="40|simple life" data-price="1049" data-name="Одноэтажный дом: simple life" class="open-popup btn">заказать со скидкой</a>
                    </div>
                </div>
            </div>
            ...
            <div class="product">
                ...
                <div class="product-content">
                    ...
                    <div class="product-price">
                        ...
                        <a href="#" onclick="return false" data-id="14|because of you " data-yd="Because-of-you" data-price="699" data-name="Одноэтажный дом: BECAUSE OF YOU" class="open-popup btn">заказать
                            со
                            скидкой </a>
                    </div>
                </div>
            ...
            <div class="product">
                ...
                <div class="product-content">
                    ...
                    <div class="product-price">
                        ...
                        <a href="#" onclick="return false" data-id="41|family nap" data-price="699" data-name="Одноэтажный дом: Family nap" class="open-popup btn">заказать со скидкой</a>
                    </div>
                </div>
            </div>
            ...
            <div class="product">
                ...
                <div class="product-content">
                    ...
                    <div class="product-price">
                        ...
                        <a href="#" onclick="return false" data-id="15|coffe time" data-price="679" data-name="Одноэтажный дом: COFFEE TIME" class="open-popup btn">заказать со скидкой</a>
                    </div>
                </div>
            </div>
            ...
            <div class="product">
                ...
                <div class="product-content">
                    ...
                    <div class="product-price">
                        ...
                        <a href="#" onclick="return false" data-id="24|chocolate shop" data-price="679" data-name="Одноэтажный дом: CHOCOLATE SHOP" class="open-popup btn">заказать со скидкой</a>
                    </div>
                </div>
            </div>
            ...
            <div class="product">
                ...
                <div class="product-content">
                    ...
                    <div class="product-price">
                        ...
                        <a href="#" onclick="return false" data-id="16|pink loft" data-price="729" data-name="Одноэтажный дом: PINK LOFT" class="open-popup btn">заказать со скидкой</a>
                    </div>
                </div>
            </div>
            ...
            <div class="product">
                ...
                <div class="product-content">
                    ...
                    <div class="product-price">
                        ...
                        <a href="#" onclick="return false" data-id="17|blue coast" data-price="729" data-name="Одноэтажный дом: BLUE COAST" class="open-popup btn">заказать со
                            скидкой</a>
            ...
            <div class="product">
                ...
                <div class="product-content">
                    ...
                    <div class="product-price">
                        ...
                        <a href="#" onclick="return false" data-id="38|coffee house" data-price=" 999" data-name="Одноэтажный дом: COFFEE HOUSE" class="open-popup btn">заказать со скидкой</a>
                    </div>
                </div>
            </div>
            ...
            <div class="product">
                ...
                <div class="product-content">
                    ...
                    <div class="product-price">
                        ...
                        <a href="#" onclick="return false" data-id="18|modern style" data-price="1249" data-name="Одноэтажный дом: MODERN STYLE" class="open-popup btn">заказать со скидкой</a>
                    </div>
                </div>
            </div>
            ...
            <div class="product">
                ...
                <div class="product-content">
                    ...
                    <div class="product-price">
                        ...
                        <a href="#" onclick="return false" data-id="19|give you happiness" data-price="1249" data-name="Одноэтажный дом: GIVE YOU HAPPINESS" class="open-popup btn">заказать со
                            скидкой</a>
                    </div>
                </div>
            </div>
...
-->
            ...
            <div class="product">
                ...
                <div class="product-content">
                    ...
                    <div class="product-price">
                        ...
                        <a href="#" onclick="return false" data-id="42|pink cafe" data-price="1649" data-name="Одноэтажный дом: pink cafe" class="open-popup btn">заказать со скидкой</a>
                    </div>
                </div>
            </div>
            ...
            <div class="product">
                ...
                <div class="product-content">
                    ...
                    <div class="product-price">
                        ...
                        <a href="#" onclick="return false" data-id="28|legend of the blue sea" data-price="1599" data-name="Одноэтажный дом: LEGEND OF THE BLUE SEA" class="open-popup btn">заказать со
                            скидкой</a>
                    </div>
                </div>
            </div>
            <div class="product">
                ...
                <div class="product-content">
                    ...
                    <div class="product-price">
                        ...
                        <a href="#" onclick="return false" data-id="21|sweet words" data-price="1649" data-name="Одноэтажный дом: SWEET WORDS" class="open-popup btn">заказать со скидкой</a>
                    </div>
                </div>
            </div>

            <section>
                <h2 class="reasons-title">3 причины, почему ваш ребенок будет в восторге от сборки Рубмокc</h2>
        ...
        <section class="revievs-wrapper">
            <div class="revievs container">
                <h2 class="revievs-title">Более 1470 довольных родителей уже приобрели Румбокс</h2>
                <ul class="revievs-list">
                    <li>
                        ...
                        <div class="revievs-list__content">
                            ...
                            <p>На День Рождения нашей Аринки решили с мужем вместо обычных конструкторов подарить ей
                                этот
                                прекрасный Румбокс. Выбрали двухэтажный))</p>
                            <p>Думали, что она сама справится, но пришлось подключиться. И скажу честно, это били
                                невероятные несколько вечеров, когда мы всей семьей весело проводили время, помогали
                                друг
        ...
        <section class="roombox container">
            <div class="revievs container"></div>
            <h2 class="slider-wrapper__title">Румбокс -это</h2>
            <ul class="roombox-list">
                <li>
                    <div class="roombox-list__icon">
                        <img src="" data-leazy="/img/roombox/1.png" class="lazy-img" alt="">
                    </div>
                    <h3 class="roombox-list__title">Увлекательная и развивающая игра для всей семьи</h3>
                </li>
                <li>
                    <div class="roombox-list__icon">
                        <img src="" data-leazy="/img/roombox/2.png" class="lazy-img" alt="">
                    </div>
                    <h3 class="roombox-list__title">Гарантированно качественные материалы от производителя</h3>
                </li>
                <li>
                    <div class="roombox-list__icon">
                        <img src="" data-leazy="/img/roombox/3.png" class="lazy-img" alt="">
                    </div>
                    <h3 class="roombox-list__title">Отличный подарок
        ...
        <section class="form-wrapper">
            <div class="form-block container">
                <p class="form-block__text">Дом мечты для вас и вашего ребенка</p>
                <h2 class="form-block__title">Развивающий и увлекательный конструктор для детей и взрослых</h2>
                <p class="form-block__des">Для заказа - оставьте заявку и наш менеджер свяжется с вами
                ...
                <form action="/" method="post" class="form">
                    ...
                    <label class="select">
                        <select name="order" class="input" required>
                            ...
                            <option value="19|gIVE YOU HAPPINESS 1249">"GIVE YOU HAPPINESS" - 1249 грн
                            </option>
